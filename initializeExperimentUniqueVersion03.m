...
% Need to add clip # and Trim.
    movieList = {'3gcWAZSNi2E_M','4dUJVqvs2Qo_M','5TLu2RXT6Gs_M','9b0OSsywmw8_M','AQDWwktBhaw_F',...
        ...
        'sZdAE3kcfT8_M','WfpZPDqNNg0_M','W-OhDc_uT6o_M'};
...
%     tempWhichExp2 = zeros(size(indexMoviesRandom2));
    ...
    for i = 1:3
        ...
        clipIDCol3 = [clipIDCol3; repmat([1:5]',size(indexMoviesSorted2,1),1)];
    end
