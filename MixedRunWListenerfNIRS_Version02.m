...
if ithSec > 1
    load([devDir filesep 'response_3M_fNIRS_' subj '_' dncstr 'Temp'],'responsesA','correctRespA','responsesV','correctRespV');
else
...
%             end
    ...
    %         end
            ...
            save([devDir filesep 'response_3M_fNIRS_' subj '_' dncstr],'responsesA','correctRespA','responsesV','correctRespV','trialStopped','cfg');
            sca;
            fprintf(1,'The identifier was:\n%s',e2.identifier);
            fprintf(1,'There was an error! The message was:\n%s',e2.message);
    ...
    if ithSec < numSec
        save([devDir filesep 'response_3M_fNIRS_' subj '_' dncstr2 '_Temp'],'responsesA','correctRespA','responsesV','correctRespV','cfg');
    else
        save([devDir filesep 'response_3M_fNIRS_' subj '_' dncstr],'responsesA','correctRespA','responsesV','correctRespV','cfg');
    end
